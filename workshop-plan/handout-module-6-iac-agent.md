# Handout: Module 6 — IaC Security Agent (Custom Copilot Agent)

> **What you'll do**: Create a custom Copilot agent that specializes in scanning Infrastructure-as-Code for security misconfigurations across Terraform, Bicep, Kubernetes, Helm, and Dockerfiles.
>
> **How**: On your fork → "Add file" → "Create new file" → path: `.github/agents/iac-security-agent.md` → paste content → commit to `main`.

---

## File: `.github/agents/iac-security-agent.md`

**Path**: `.github/agents/iac-security-agent.md`
...
4. **Assignees**: `copilot`
5. Submit → Copilot will use the IaCSecurityAgent to generate a comprehensive security report

---

## What This Demonstrates

- **Custom Agents**: Specialized versions of Copilot with domain expertise, defined as markdown
- **DevSecOps**: Automated infrastructure security scanning without additional tooling
- **Reusability**: The same agent can be invoked from issues, PRs, or agentic workflows
