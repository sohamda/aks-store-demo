...
> **Fork Purpose:** This fork is used as the hands-on lab environment for an **Agentic DevSecOps Workshop** powered by **GitHub Copilot**. It demonstrates how to leverage GitHub Copilot's agentic capabilities across the software development lifecycle—including code generation, security analysis, infrastructure-as-code authoring, testing, and deployment—within a realistic microservices application.
